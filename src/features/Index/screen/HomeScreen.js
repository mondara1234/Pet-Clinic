                ...
                <Container>
                    <View style={styles.container}>
                            ...
                            <CardItem>
                                <Body style={styles.cardBody}>
                                    ...
                                    <View style={styles.containerText}>
                                        ...
                                        <CommonText text={'นัดฉีดวัสซีน'} size={18} style={{marginLeft: 10}} />
                                    </View>
                                    <View style={styles.containerText}>
                                        <CommonText text={'ผู้รับผิดชอบ : '} size={18} style={{fontWeight: 'bold'}} />
                                        <CommonText text={'นาย กมลพัชร์ พิสุทธิกมล'} size={18} style={{marginLeft: 10}} />
                                    </View>
                        ...
                        <View style={styles.containerSliding}>
                            <TouchableOpacity
                                onPress={ () => this.props.navigation.navigate({routeName: SLEDGING_SCREEN, params: { title: 'โรคท้องผูก' }})}
                            >
...
export default connect(
    ...
    (dispatch) => ({
        ...
        FETCH_Searchledging: bindActionCreators(ALLSLEDGING, dispatch)
    })
)(homeScreen);
